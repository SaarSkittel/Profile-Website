    ...
    <div className="home">
      ...
      <Container maxWidth="lg" className={classes.projectContainer}>
        ...
        <Grid container spacing={3} marginBottom="100px">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <ProjectCard
              name="Gender Classification From Text In Hebrew "
              image="./images/gender_classification/ml main.jpg"
              description="ML project written in Python using Jupiter Notebook utilizing Pandas and scikit-learn libraries"
              link="/gender_classification"
            />
            </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <ProjectCard
